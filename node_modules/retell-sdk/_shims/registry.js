...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'retell-sdk/shims/${shims.kind}'\` before importing anything else from retell-sdk`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'retell-sdk/shims/${shims.kind}'\` after \`import 'retell-sdk/shims/${exports.kind}'\``);
    }
